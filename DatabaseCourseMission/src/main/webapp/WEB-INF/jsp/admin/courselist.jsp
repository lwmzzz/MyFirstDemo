					...
					<div class="panel-heading">
						<div class="row">
							...
							<form class="bs-example bs-example-form col-md-5" role="form"
								style="margin: 20px 0 10px 0;" action=${pageContext.request.contextPath}/admin/selectcourse
								...
								<tr>
									...
									<td>
										<button class="btn btn-default btn-xs btn-info"
											onClick="location.href='tt/admin/editcourse?id=${item.courseId}'">修改</button>
										<button class="btn btn-default btn-xs btn-danger btn-primary"
											onClick="location.href='tt/admin/removecourse?id=${item.courseId}'">删除</button>
										<!--弹出框-->
									</td>
								</tr>
							</c:forEach>
